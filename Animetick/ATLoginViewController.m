...
- (void)viewDidLoad
{
    ...
    NSURL *url = [NSURL URLWithString:@"http://kazz187:h8xelpr1@anitick.net:3000/app/login"];
...
- (void)connectionSample
{
    ...
    NSURL *url = [NSURL URLWithString:@"http://kazz187:h8xelpr1@anitick.net:3000/ticket/list/0.json"];
    ...
    NSDictionary *cookieProperties = @{NSHTTPCookieName: @"_animetick_session",
                                       ...
                                       NSHTTPCookieDomain: @"anitick.net",
                                       NSHTTPCookiePath: @"\\",
